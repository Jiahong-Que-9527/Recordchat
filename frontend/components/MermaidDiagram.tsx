...
async function getMermaid() {
  ...
  if (!initialized) {
    mermaid.initialize({
      ...
      themeVariables: {
        // Match the app's azure accent (from recordchat_icon.png) + slate neutrals.
        primaryColor: "#e6f1fd",
        primaryBorderColor: "#0b65fe",
        primaryTextColor: "#0f172a",
        secondaryColor: "#f4f8fe",
        secondaryBorderColor: "#bad9fc",
        tertiaryColor: "#ffffff",
        tertiaryBorderColor: "#dbe7f8",
        lineColor: "#94a3b8",
        textColor: "#334155",
        mainBkg: "#e6f1fd",
        nodeBorder: "#0b65fe",
        clusterBkg: "#f4f8fe",
        clusterBorder: "#dbe7f8",
        titleColor: "#0f172a",
